...
namespace Project_WAD.Areas.Admin.Controllers
{
    public class OrderDetailsController : BaseController
    {
        ...
        public async Task<IActionResult> Create([Bind("OrderId,ProductId,Quantity,Price")] OrderDetail orderDetail)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("OrderId,ProductId,Quantity,Price")] OrderDetail orderDetail)
        {
